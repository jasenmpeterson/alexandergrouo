define(['./axios'],function (axios) {
    return function (url) {
        ...
        if (typeof (document.querySelector('.ajax--button')) !== 'undefined' && document.querySelector('.ajax--button') !== null) {
            ...
            // close ajax modal :
            if (typeof (ajax_close) !== 'undefined' && ajax_close !== null) {
            ...
            // leadership profiles:
            if(typeof document.querySelector('.ajax--profile--button') !== 'undefined') {
